...
class CreateVisitorsScreeningsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('visitors_screenings', function (Blueprint $table) {
            $table->increments('id');
			...
			$table->integer('captured_id')->nullable();
    ...
    {
        Schema::dropIfExists('visitors_screenings');
    }
}
