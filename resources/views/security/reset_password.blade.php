    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                <form class="form-horizontal" method="POST" action="/users/get_reset_password">
                    {{ csrf_field() }}
                    <div class="box-header with-border">
                        <h3 class="box-title">Users Details Search</h3>
                    ...
                    <div class="box-footer">
                        <button type="submit" id="add-new-module" class="btn btn-primary pull-right" data-toggle="modal" data-target="#add-new-module-modal"><i class="fa fa-search"></i> Submit</button>
                    </div>
                </form>
            </div>
        </div>
