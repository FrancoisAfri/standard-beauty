									...
									@if(!empty($screenings))
										@foreach($screenings as $screening)
											<tr bgcolor="{{!empty($screening->background_temp) ? $screening->background_temp : ''}}">
												...
												<td>{{ !empty($screening->client_name) ? $screening->client_name : '' }}</td>
												<td>{{ !empty($screening->new_id_number) ? $screening->new_id_number : '' }}</td>
												<td>{{ !empty($screening->cell_number) ? $screening->cell_number : '' }}</td>
												...
												@if(empty($screening->background))
													<td><a target="_blank" href="{{ '/screening/view/visitors-questions/' . $screening->id}}" class="btn btn-xs btn-flat">Good</a></td>
												@else
													<td><a target="_blank" href="{{ '/screening/view/visitors-questions/' . $screening->id}}" class="btn btn-xs btn-flat">Not Good</a></td>
												@endif
