...
<head>
    ...
    <title>{{ $company_name }} - New Request For Quotation</title>
                            ...
                            <table cellpadding="0" cellspacing="0" class="force-full-width">
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                            <tr>
                                                <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                    Good Day,<br><br>
                                                    We would like you to inform you that there is a new request from quotation
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>
                                                                                            <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
																								...
																								<tr>
                                                                                                    <td width="150" class="data-heading">
                                                                                                        Would you be interested in advertising your company on all our portals:
                                                                                                    </td>
                                                                                                    <td class="data-value">
                                                                                                        <b>{{ $adv }}</b>
                                                                                                    </td>
                                ...
                                <tr>
                                    <td valign="top" class="footer-cell">
										...
										Powered by <a href="http://afrixcel.co.za/" target="_blank">Mkhaya MK</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
